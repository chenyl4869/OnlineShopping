<template>
    <div>
            ...
            <div class="container">
              <div class="checkout-addr">
                ...
                <div class="addr-list-wrap">
                  <div class="addr-list">
                    <ul>
                      <li v-for="(item, index) in addressListFilter" @click = "currIndex = index; selectedAddId = item.addressId" v-bind:class = "{'check': index == currIndex}">
                        <dl>
                          <dt>{{item.userName}}</dt>
                        ...
                        <div class="addr-opration addr-set-default">
                          <a href="javascript:;" class="addr-set-default-btn" v-if="item.isDefault == false" @click = "setDefault(item.addressId)"><i>Set default</i></a>
                        </div>
        ...
        <model v-bind:mdShow="isMdShow" @close = "closeModel">
            <p slot = "message">Are you sure to delete this address</p>
            <div slot = "btnGroup">
          ...
          axios.get("/users/addressList").then((response)=>{
            ...
            this.addressList.some((item, index)=>{
                if(item.isDefault == true){
                  ...
                  this.selectedAddId = item.addressId;
                  return true;
                }
            });
